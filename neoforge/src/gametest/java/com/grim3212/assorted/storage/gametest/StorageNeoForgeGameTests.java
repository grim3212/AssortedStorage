 ...
 * {@code AssortedStorageNeoForge}: nothing in {@code main} may reference the gametest source set,
 * or the tests would have to live in {@code main} and would ship in the jar. FML discovers this
...
public final class StorageNeoForgeGameTests {

    private StorageNeoForgeGameTests() {
    }
