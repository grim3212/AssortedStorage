...
public class StorageItems {
	...
	public static final RegistryObject<CombinationItem> LOCKSMITH_LOCK = register("locksmith_lock", () -> new CombinationItem(new Item.Properties().group(AssortedStorage.ASSORTED_STORAGE_ITEM_GROUP)));
