...
import com.grim3212.assorted.storage.common.block.tileentity.BasicLockedTileEntity;
...
public class LockedDoorBlock extends DoorBlock {
	...
	public float getPlayerRelativeBlockHardness(BlockState state, PlayerEntity player, IBlockReader worldIn, BlockPos pos) {
		...
		if (te instanceof BasicLockedTileEntity) {
			BasicLockedTileEntity tileentity = (BasicLockedTileEntity) te;
	...
	public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
		if (state.getBlock() != newState.getBlock()) {
			...
			if (tileentity instanceof BasicLockedTileEntity) {
				BasicLockedTileEntity teStorage = (BasicLockedTileEntity) tileentity;
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return new BasicLockedTileEntity();
	}
	...
	protected boolean canBeLocked(IWorld worldIn, BlockPos pos) {
		return !((BasicLockedTileEntity) worldIn.getTileEntity(pos)).isLocked();
	}

	private boolean removeLock(World worldIn, BlockPos pos, PlayerEntity entityplayer) {
		BasicLockedTileEntity tileentity = (BasicLockedTileEntity) worldIn.getTileEntity(pos);
