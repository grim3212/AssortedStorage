...
public class CrateContainer extends AbstractContainerMenu {
	...
	private final CrateBlockEntity inventory;
	...
	public CrateContainer(MenuType<? extends CrateContainer> menuType, int windowId, Inventory playerInventory, CrateBlockEntity inventory) {
