...
public class WoodCabinetTileEntity extends BaseStorageTileEntity {

	public WoodCabinetTileEntity() {
		super(StorageTileEntityTypes.WOOD_CABINET.get());
	}
	...
	protected ITextComponent getDefaultName() {
		return new TranslationTextComponent(AssortedStorage.MODID + ".container.wood_cabinet");
	}

	@Override
	public Block getBlockToUse() {
		return StorageBlocks.WOOD_CABINET.get();
	}
