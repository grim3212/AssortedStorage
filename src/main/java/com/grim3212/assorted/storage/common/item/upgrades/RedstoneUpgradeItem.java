...
public class RedstoneUpgradeItem extends ModeCrateUpgradeItem {
	...
	protected Component modeDisplay(ItemStack stack) {
		...
		return Component.translatable(AssortedStorage.MODID + ".info.upgrade.mode", Component.translatable(AssortedStorage.MODID + modeKey, currentMode).withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.AQUA);
	}
