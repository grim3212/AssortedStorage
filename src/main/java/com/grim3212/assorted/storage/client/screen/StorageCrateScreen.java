...
@OnlyIn(Dist.CLIENT)
public class StorageCrateScreen extends AbstractContainerScreen<StorageCrateContainer> implements MenuAccess<StorageCrateContainer> {

	protected static final ResourceLocation CHECKBOX_LOCATION = new ResourceLocation("textures/gui/checkbox.png");
	private static final ResourceLocation TEXTURE = new ResourceLocation(AssortedStorage.MODID, "textures/gui/container/storage_crate.png");
	private ItemStack renderStack;

	public StorageCrateScreen(StorageCrateContainer container, Inventory playerInventory, Component title) {
	...
	private ImageToggleButton createImageButton(int x, int y, int slot) {
		...
		return new ImageToggleButton(i + x, j + y, 10, 10, 0, 0, 10, CHECKBOX_LOCATION, 32, 32, (button) -> {
			StorageCrateScreen.this.toggleSlotLock(slot);
