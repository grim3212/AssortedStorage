...
public class CabinetModel extends BaseStorageModel {
	...
	public void initModel() {
		this.cabinetMain = new ModelRenderer(this, 0, 0).setTextureSize(64, 48);
		this.cabinetInt[0] = new ModelRenderer(this, -1, 0).setTextureSize(64, 48);
		this.cabinetInt[1] = new ModelRenderer(this, 14, -1).setTextureSize(64, 48);
		this.cabinetInt[2] = new ModelRenderer(this, 0, 0).setTextureSize(64, 48);
		this.cabinetInt[3] = new ModelRenderer(this, 0, 0).setTextureSize(64, 48);
		this.cabinetInt[4] = new ModelRenderer(this, 0, 0).setTextureSize(64, 48);
		this.cabinetDoor1 = new ModelRenderer(this, this.glassDoor ? 16 : 0, 32).setTextureSize(64, 48);
		this.cabinetDoor2 = new ModelRenderer(this, this.glassDoor ? 16 : 0, 32).setTextureSize(64, 48);
		this.cabinetHandle1 = new ModelRenderer(this, 0, 0).setTextureSize(64, 48);
		this.cabinetLock = new ModelRenderer(this, 48, 0).setTextureSize(64, 48);
		this.cabinetHandle2 = new ModelRenderer(this, 0, 0).setTextureSize(64, 48);
