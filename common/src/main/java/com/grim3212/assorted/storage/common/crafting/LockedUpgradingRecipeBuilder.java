...
public class LockedUpgradingRecipeBuilder implements RecipeBuilder {
    ...
    public LockedUpgradingRecipeBuilder(ItemLike p_126114_, int p_126115_) {
        this.result = p_126114_.asItem();
        this.count = p_126115_;
    }

    public static LockedUpgradingRecipeBuilder shaped(ItemLike p_126117_) {
        return shaped(p_126117_, 1);
    }

    public static LockedUpgradingRecipeBuilder shaped(ItemLike p_126119_, int p_126120_) {
        return new LockedUpgradingRecipeBuilder(p_126119_, p_126120_);
    }

    public LockedUpgradingRecipeBuilder define(Character p_206417_, TagKey<Item> p_206418_) {
        return this.define(p_206417_, Ingredient.of(p_206418_));
    }

    public LockedUpgradingRecipeBuilder define(Character p_126128_, ItemLike p_126129_) {
        return this.define(p_126128_, Ingredient.of(p_126129_));
    }

    public LockedUpgradingRecipeBuilder define(Character p_126125_, Ingredient p_126126_) {
    ...
    public LockedUpgradingRecipeBuilder pattern(String p_126131_) {
    ...
    public LockedUpgradingRecipeBuilder unlockedBy(String p_126133_, CriterionTriggerInstance p_126134_) {
        this.advancement.addCriterion(p_126133_, p_126134_);
        return this;
    }

    public LockedUpgradingRecipeBuilder group(@Nullable String p_126146_) {
