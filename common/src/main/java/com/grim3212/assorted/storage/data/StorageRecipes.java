...
public class StorageRecipes extends ConditionalRecipeProvider {
    ...
    public void buildRecipes() {
        ...
        ShapedRecipeBuilder.shaped(this.items, RecipeCategory.DECORATIONS, StorageBlocks.OAK_WAREHOUSE_CRATE.get()).define('P', Items.OAK_PLANKS).define('L', ItemTags.OAK_LOGS).pattern("LLL").pattern("P P").pattern("PPP").unlockedBy("has_oak_planks", has(Items.OAK_PLANKS)).save(this.output);
        ShapedRecipeBuilder.shaped(this.items, RecipeCategory.DECORATIONS, StorageBlocks.BIRCH_WAREHOUSE_CRATE.get()).define('P', Items.BIRCH_PLANKS).define('L', ItemTags.BIRCH_LOGS).pattern("LLL").pattern("P P").pattern("PPP").unlockedBy("has_birch_planks", has(Items.BIRCH_PLANKS)).save(this.output);
        ShapedRecipeBuilder.shaped(this.items, RecipeCategory.DECORATIONS, StorageBlocks.SPRUCE_WAREHOUSE_CRATE.get()).define('P', Items.SPRUCE_PLANKS).define('L', ItemTags.SPRUCE_LOGS).pattern("LLL").pattern("P P").pattern("PPP").unlockedBy("has_spruce_planks", has(Items.SPRUCE_PLANKS)).save(this.output);
        ShapedRecipeBuilder.shaped(this.items, RecipeCategory.DECORATIONS, StorageBlocks.ACACIA_WAREHOUSE_CRATE.get()).define('P', Items.ACACIA_PLANKS).define('L', ItemTags.ACACIA_LOGS).pattern("LLL").pattern("P P").pattern("PPP").unlockedBy("has_acacia_planks", has(Items.ACACIA_PLANKS)).save(this.output);
        ShapedRecipeBuilder.shaped(this.items, RecipeCategory.DECORATIONS, StorageBlocks.DARK_OAK_WAREHOUSE_CRATE.get()).define('P', Items.DARK_OAK_PLANKS).define('L', ItemTags.DARK_OAK_LOGS).pattern("LLL").pattern("P P").pattern("PPP").unlockedBy("has_dark_oak_planks", has(Items.DARK_OAK_PLANKS)).save(this.output);
        ShapedRecipeBuilder.shaped(this.items, RecipeCategory.DECORATIONS, StorageBlocks.JUNGLE_WAREHOUSE_CRATE.get()).define('P', Items.JUNGLE_PLANKS).define('L', ItemTags.JUNGLE_LOGS).pattern("LLL").pattern("P P").pattern("PPP").unlockedBy("has_jungle_planks", has(Items.JUNGLE_PLANKS)).save(this.output);
        ShapedRecipeBuilder.shaped(this.items, RecipeCategory.DECORATIONS, StorageBlocks.WARPED_WAREHOUSE_CRATE.get()).define('P', Items.WARPED_PLANKS).define('L', Items.WARPED_STEM).pattern("LLL").pattern("P P").pattern("PPP").unlockedBy("has_warped_planks", has(Items.WARPED_PLANKS)).save(this.output);
        ShapedRecipeBuilder.shaped(this.items, RecipeCategory.DECORATIONS, StorageBlocks.CRIMSON_WAREHOUSE_CRATE.get()).define('P', Items.CRIMSON_PLANKS).define('L', Items.CRIMSON_STEM).pattern("LLL").pattern("P P").pattern("PPP").unlockedBy("has_crimson_planks", has(Items.CRIMSON_PLANKS)).save(this.output);
        ShapedRecipeBuilder.shaped(this.items, RecipeCategory.DECORATIONS, StorageBlocks.MANGROVE_WAREHOUSE_CRATE.get()).define('P', Items.MANGROVE_PLANKS).define('L', Items.MANGROVE_LOG).pattern("LLL").pattern("P P").pattern("PPP").unlockedBy("has_mangrove_planks", has(Items.MANGROVE_PLANKS)).save(this.output);
