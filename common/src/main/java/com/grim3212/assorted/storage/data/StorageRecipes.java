...
public class StorageRecipes extends ConditionalRecipeProvider {
    ...
    public void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        SpecialRecipeBuilder.special(LockedEnderChestRecipe.SERIALIZER).save(consumer, Identifier.fromNamespaceAndPath(Constants.MOD_ID, "locked_ender_chest").toString());
        SpecialRecipeBuilder.special(LockedChestRecipe.SERIALIZER).save(consumer, Identifier.fromNamespaceAndPath(Constants.MOD_ID, "locked_chest").toString());
        SpecialRecipeBuilder.special(LockedBarrelRecipe.SERIALIZER).save(consumer, Identifier.fromNamespaceAndPath(Constants.MOD_ID, "locked_barrel").toString());
        SpecialRecipeBuilder.special(LockedShulkerBoxRecipe.SERIALIZER).save(consumer, Identifier.fromNamespaceAndPath(Constants.MOD_ID, "locked_shulker_box").toString());
        SpecialRecipeBuilder.special(LockedShulkerBoxColoring.SERIALIZER).save(consumer, Identifier.fromNamespaceAndPath(Constants.MOD_ID, "shulker_box_coloring").toString());
        SpecialRecipeBuilder.special(BagColoringRecipe.SERIALIZER).save(consumer, Identifier.fromNamespaceAndPath(Constants.MOD_ID, "bag_coloring").toString());
        ...
        for (Map.Entry<StorageMaterial, IRegistryObject<LockedHopperBlock>> hopper : StorageBlocks.HOPPERS.entrySet()) {
            ...
            LockedUpgradingRecipeBuilder.shaped(hopper.getValue().get(), 1).define('C', matchChest).define('M', LibCommonTags.Items.INGOTS_IRON).pattern("M M").pattern("MCM").pattern(" M ").unlockedBy("has_chest", has(matchChest)).unlockedBy("has_iron", has(LibCommonTags.Items.INGOTS_IRON)).save(consumer, Identifier.parse(hopper.getValue().getId() + "_chest"));
        ...
        for (Map.Entry<StorageMaterial, IRegistryObject<BagItem>> bag : StorageItems.BAGS.entrySet()) {
            ...
            LockedUpgradingRecipeBuilder.shaped(bag.getValue().get(), 1).define('C', matchChest).define('S', LibCommonTags.Items.STRING).define('L', LibCommonTags.Items.LEATHER).pattern("SLS").pattern("LCL").pattern("LLL").unlockedBy("has_chest", has(matchChest)).unlockedBy("has_leather", has(LibCommonTags.Items.LEATHER)).save(consumer, Identifier.parse(bag.getValue().getId() + "_chest"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, StorageItems.ROTATOR_MAJIG.get(), 1).define('B', LibCommonTags.Items.RODS_BLAZE).define('S', LibCommonTags.Items.RODS_WOODEN).define('I', LibCommonTags.Items.INGOTS_IRON).pattern("I I").pattern(" B ").pattern(" S ").unlockedBy("has_blaze_rod", has(LibCommonTags.Items.RODS_BLAZE)).save(consumer, Identifier.parse(StorageItems.ROTATOR_MAJIG.getId() + "_iron"));
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, StorageItems.ROTATOR_MAJIG.get(), 1).define('B', LibCommonTags.Items.RODS_BLAZE).define('S', LibCommonTags.Items.RODS_WOODEN).define('I', LibCommonTags.Items.INGOTS_IRON).pattern("I I").pattern(" S ").pattern(" B ").unlockedBy("has_blaze_rod", has(LibCommonTags.Items.RODS_BLAZE)).save(consumer, Identifier.parse(StorageItems.ROTATOR_MAJIG.getId() + "_iron_alt"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, StorageItems.ROTATOR_MAJIG.get(), 1).define('B', LibCommonTags.Items.RODS_BLAZE).define('S', LibCommonTags.Items.RODS_WOODEN).define('I', StorageTags.Items.INGOTS_ALUMINUM).pattern("I I").pattern(" S ").pattern(" B ").unlockedBy("has_blaze_rod", has(LibCommonTags.Items.RODS_BLAZE)).save(consumer, Identifier.parse(StorageItems.ROTATOR_MAJIG.getId() + "_aluminum_alt"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, StorageItems.ROTATOR_MAJIG.get(), 1).define('B', LibCommonTags.Items.RODS_BLAZE).define('S', LibCommonTags.Items.RODS_WOODEN).define('I', StorageTags.Items.INGOTS_STEEL).pattern("I I").pattern(" S ").pattern(" B ").unlockedBy("has_blaze_rod", has(LibCommonTags.Items.RODS_BLAZE)).save(consumer, Identifier.parse(StorageItems.ROTATOR_MAJIG.getId() + "_steel_alt"));
