...
public enum StorageMaterial implements StringRepresentable {
    ...
    STONE("stone", () -> LibCommonTags.Items.STONE, new ResourceLocation("block/stone"), 0, 3, 9, 1, 5, () -> Block.Properties.of(Material.STONE).sound(SoundType.STONE).strength(3.5F).requiresCorrectToolForDrops()),
    COPPER("copper", () -> LibCommonTags.Items.INGOTS_COPPER, new ResourceLocation("block/copper_block"), 1, 4, 9, 1, 6, () -> Block.Properties.of(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectToolForDrops().strength(3.0F, 6.0F)),
    IRON("iron", () -> LibCommonTags.Items.INGOTS_IRON, new ResourceLocation("block/iron_block"), 1, 5, 9, 1, 8, 5.0F, 6.0F),
    AMETHYST("amethyst", () -> LibCommonTags.Items.GEMS_AMETHYST, new ResourceLocation("block/amethyst_block"), 2, 6, 9, 1, 7, () -> Block.Properties.of(Material.AMETHYST).sound(SoundType.AMETHYST).requiresCorrectToolForDrops().strength(1.5F)),
    EMERALD("emerald", () -> LibCommonTags.Items.GEMS_EMERALD, new ResourceLocation("block/emerald_block"), 2, 7, 9, 1, 9, () -> Block.Properties.of(Material.METAL, MaterialColor.EMERALD).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(5.0F, 6.0F)),
    GOLD("gold", () -> LibCommonTags.Items.INGOTS_GOLD, new ResourceLocation("block/gold_block"), 3, 8, 9, 2, 5, () -> Block.Properties.of(Material.METAL, MaterialColor.GOLD).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(3.0F, 6.0F)),
    DIAMOND("diamond", () -> LibCommonTags.Items.GEMS_DIAMOND, new ResourceLocation("block/diamond_block"), 4, 9, 11, 3, 5, () -> Block.Properties.of(Material.METAL, MaterialColor.DIAMOND).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(5.0F, 6.0F)),
    NETHERITE("netherite", () -> LibCommonTags.Items.INGOTS_NETHERITE, new ResourceLocation("block/netherite_block"), 5, 9, 14, 3, 9, () -> Block.Properties.of(Material.METAL, MaterialColor.COLOR_BLACK).sound(SoundType.NETHERITE_BLOCK).requiresCorrectToolForDrops().strength(50.0F, 1200.0F)),
    ...
    TOPAZ("topaz", () -> StorageTags.Items.GEMS_TOPAZ, new ResourceLocation(Constants.MOD_ID, "block/particle/topaz_block"), 1, 5, 9, 1, 7, () -> Block.Properties.of(Material.METAL, MaterialColor.COLOR_YELLOW).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(5.0F, 6.0F)),
    PERIDOT("peridot", () -> StorageTags.Items.GEMS_PERIDOT, new ResourceLocation(Constants.MOD_ID, "block/particle/peridot_block"), 2, 6, 9, 1, 7, () -> Block.Properties.of(Material.METAL, MaterialColor.COLOR_GREEN).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(5.0F, 6.0F)),
    ...
    SAPPHIRE("sapphire", () -> StorageTags.Items.GEMS_SAPPHIRE, new ResourceLocation(Constants.MOD_ID, "block/particle/sapphire_block"), 2, 7, 9, 1, 9, () -> Block.Properties.of(Material.METAL, MaterialColor.COLOR_BLUE).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(5.0F, 6.0F)),
    ...
    RUBY("ruby", () -> StorageTags.Items.GEMS_RUBY, new ResourceLocation(Constants.MOD_ID, "block/particle/ruby_block"), 3, 9, 10, 2, 6, () -> Block.Properties.of(Material.METAL, MaterialColor.COLOR_RED).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(5.0F, 6.0F)),
    ...
    private StorageMaterial(String name, Supplier<TagKey<Item>> material, ResourceLocation particle, int storageLevel, int xRows, int yCols, int hopperXRows, int hopperYCols, float destroyTime, float explosionResistance) {
        this(name, material, particle, storageLevel, xRows, yCols, hopperXRows, hopperYCols, () -> Block.Properties.of(Material.METAL).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(destroyTime, explosionResistance));
    }
