...
public class WarehouseCrateBlockEntity extends BaseStorageBlockEntity {
    ...
    public WarehouseCrateBlockEntity(BlockPos pos, BlockState state) {
        super(StorageBlockEntityTypes.WAREHOUSE_CRATE.get(), pos, state);
    }
    ...
    protected Component getDefaultName() {
        return Component.translatable(Constants.MOD_ID + ".container.warehouse_crate");
    }
}
