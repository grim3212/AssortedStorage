...
public class StorageBlockEntityTypes {
    ...
    public static final IRegistryObject<BlockEntityType<WoodCabinetBlockEntity>> WOOD_CABINET = BLOCK_ENTITIES.register("wood_cabinet", () -> Services.PLATFORM.createBlockEntityType(WoodCabinetBlockEntity::new, StorageBlocks.WOOD_CABINET.get()));
    public static final IRegistryObject<BlockEntityType<GlassCabinetBlockEntity>> GLASS_CABINET = BLOCK_ENTITIES.register("glass_cabinet", () -> Services.PLATFORM.createBlockEntityType(GlassCabinetBlockEntity::new, StorageBlocks.GLASS_CABINET.get()));
    public static final IRegistryObject<BlockEntityType<GoldSafeBlockEntity>> GOLD_SAFE = BLOCK_ENTITIES.register("gold_safe", () -> Services.PLATFORM.createBlockEntityType(GoldSafeBlockEntity::new, StorageBlocks.GOLD_SAFE.get()));
    public static final IRegistryObject<BlockEntityType<ObsidianSafeBlockEntity>> OBSIDIAN_SAFE = BLOCK_ENTITIES.register("obsidian_safe", () -> Services.PLATFORM.createBlockEntityType(ObsidianSafeBlockEntity::new, StorageBlocks.OBSIDIAN_SAFE.get()));
    public static final IRegistryObject<BlockEntityType<LockerBlockEntity>> LOCKER = BLOCK_ENTITIES.register("locker", () -> Services.PLATFORM.createBlockEntityType(LockerBlockEntity::new, StorageBlocks.LOCKER.get()));
    public static final IRegistryObject<BlockEntityType<ItemTowerBlockEntity>> ITEM_TOWER = BLOCK_ENTITIES.register("item_tower", () -> Services.PLATFORM.createBlockEntityType(ItemTowerBlockEntity::new, StorageBlocks.ITEM_TOWER.get()));
    ...
    public static final IRegistryObject<BlockEntityType<CrateCompactingBlockEntity>> CRATE_COMPACTING = BLOCK_ENTITIES.register("crate_compacting", () -> Services.PLATFORM.createBlockEntityType(CrateCompactingBlockEntity::new, StorageBlocks.CRATE_COMPACTING.get()));
