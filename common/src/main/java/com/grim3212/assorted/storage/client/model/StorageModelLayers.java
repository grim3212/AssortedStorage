...
public class StorageModelLayers {
    ...
    public static final ModelLayerLocation LOCKED_SHULKER_BOX = new ModelLayerLocation(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "locked_shulker_box"), "main");
}
